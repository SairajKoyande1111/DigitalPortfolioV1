...
export const projects: Project[] = [
  ...
  // Software Development Projects
  {
    id: "s1",
    serviceId: "3",
    name: "EnterpriseFlow ERP System",
    shortDescription: "Comprehensive enterprise resource planning system for manufacturing operations.",
    fullDescription: "Built a complete ERP solution for a mid-sized manufacturing company. The system integrates inventory management, production planning, quality control, HR management, and financial reporting. Custom dashboards provide real-time insights while automated workflows streamline operations across departments.",
    ...
    websiteUrl: "https://enterpriseflow-erp.com",
    duration: "12 months",
    completedDate: "May 2024",
    technologies: ["Python", "Django", "PostgreSQL", "Redis", "Docker", "Kubernetes"],
    features: ["Inventory Management", "Production Planning", "Quality Control", "HR Module", "Financial Reporting", "Custom Dashboards"],
    outcomes: ["40% increase in operational efficiency", "60% reduction in manual data entry", "ROI achieved in 8 months"]
  },
  {
    id: "s2",
    serviceId: "3",
    name: "DataVault Analytics Platform",
    shortDescription: "Business intelligence platform with advanced data visualization and reporting.",
    fullDescription: "DataVault is a powerful analytics platform that transforms raw data into actionable insights. The system includes data connectors for various sources, ETL pipelines, custom report builders, interactive dashboards, and automated scheduled reports. Machine learning models provide predictive analytics and anomaly detection.",
    imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop",
    galleryImages: [
    ...
    clientName: "Insight Analytics Ltd.",
    clientIndustry: "Business Intelligence",
    clientLocation: "Boston, MA",
    websiteUrl: "https://datavault-analytics.io",
    duration: "8 months",
    completedDate: "April 2024",
    technologies: ["Python", "Apache Spark", "Elasticsearch", "React", "D3.js", "TensorFlow"],
    features: ["Data Connectors", "ETL Pipelines", "Report Builder", "Interactive Dashboards", "Predictive Analytics", "Automated Reports"],
    outcomes: ["70% faster report generation", "50% improvement in decision-making speed", "30% cost reduction in data management"]
  },
  {
    id: "s3",
    serviceId: "3",
    name: "SecureVault Access Control",
    shortDescription: "Enterprise-grade security system with biometric authentication and audit logging.",
    fullDescription: "Developed a comprehensive security and access control system for large organizations. Features include multi-factor authentication, biometric integration, role-based access control, real-time monitoring, and detailed audit logging. The system ensures compliance with industry regulations while providing seamless user experience.",
    ...
    clientName: "SecureFirst Banking",
    clientIndustry: "Financial Services",
    clientLocation: "New York, NY",
    websiteUrl: "https://securevault-access.com",
    duration: "10 months",
    completedDate: "March 2024",
    technologies: ["Java", "Spring Boot", "Oracle", "Keycloak", "LDAP", "AWS"],
    features: ["Multi-factor Auth", "Biometric Integration", "Role-based Access", "Real-time Monitoring", "Audit Logging", "Compliance Reports"],
    outcomes: ["Zero security breaches", "99.99% uptime", "Regulatory compliance achieved"]
  },
